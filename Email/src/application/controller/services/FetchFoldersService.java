...
public class FetchFoldersService extends Service<Void> {
	...
	private static int NUMBER_OF_FETCHFOLDERSSERVICE_ACTIVE = 0;
	...
	public FetchFoldersService(EmailFolderBean<String> foldersRoot, EmailAccountBean emailAccountBean, ModelAccess modelAccess) {
		...
		this.setOnSucceeded(e -> NUMBER_OF_FETCHFOLDERSSERVICE_ACTIVE--);
	}
	...
	protected Task<Void> createTask() {
		return new Task<Void>() {
			protected Void call() throws Exception {
				NUMBER_OF_FETCHFOLDERSSERVICE_ACTIVE++;
	...
	public static boolean noServicesActive() {
		return NUMBER_OF_FETCHFOLDERSSERVICE_ACTIVE == 0;
	}
